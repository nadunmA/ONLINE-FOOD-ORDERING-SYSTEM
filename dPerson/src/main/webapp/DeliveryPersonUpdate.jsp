...
<div class="overlay absolute top-0 left-0 w-full h-full bg-black bg-opacity-40 z-0"> 
	...
	<div class="flex z-10 items-center justify-center h-screen">
		  ...
		  <div>    
			  ...
			  <input type="text" name="dpId" value="<%=dpId%>" required class="font-sans w-full p-1 rounded-[16px] text-black"/><br/>
		  </div>

		   <div>
			  <label class="block mb-1">Name : </label>
			  <input type="text" name="name" value="<%=name%>" required class="font-sans w-full p-1 rounded-[16px] text-black"/><br/>
		  </div>

		  <div>
			  <label class="block mb-1">Phone : </label>
			  <input type="text" name="phone" value="<%=phone%>" required class="font-sans w-full p-1 rounded-[16px] text-black"/><br/>
		  </div>

		  <div>
			  <label class="block mb-1">Email : </label>
			  <input type="email" name="email" value="<%=email%>" required class="font-sans w-full p-1 rounded-[16px] text-black"/><br/>
		  </div>

		  <div>
			  <label class="block mb-1">Location : </label>
			  <input type="text" name="location" value="<%=location%>" class="font-sans w-full p-1 rounded-[16px] text-black"/><br/>
		  </div>

		  <div>
			  <label class="block mb-1">Assigned Orders : </label>
			  <input type="text" name="assignedOrders" value="<%=assignedOrders%>" class="font-sans w-full p-1 rounded-[16px] text-black"/><br/>
		  </div>

		  <div>
			  <label class="block mb-1">Payment Status : </label>
			  <select name="paymentStatus" value="<%=paymentStatus%>" class="font-sans w-full p-1 rounded-[16px] text-black">
		  ...
		  <div>
			  ...
			  <select name="orderStatus" value="<%=orderStatus%>" class="font-sans w-full p-1 rounded-[16px] text-black">
